...
void Com_ReadSignalGroupFromPduBuffer(const Com_SignalGroupIdType SignalGroupId);

void Com_UnPackSignalGroupsFromPdu(uint16 ComIPuId);

void Com_ReadGroupSignalDataFromGroupSignalBuffer (const uint16 signalId,  void * signalData) ;
