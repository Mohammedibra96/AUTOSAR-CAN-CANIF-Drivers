 ...
 */
extern CONST(uint32_t,AUTOMATIC) CanHwFilterMask[MAX_NUM_FILTERS]   ;
...
FUNC(void,CAN_CODE)  Can_MainFunction_Write(void)
    ...
    VAR(uint8_t,AUTOMATIC) HwIndex                      ;
    VAR(uint8_t,AUTOMATIC) CanHwObjectIndex;
    /*Check the busy flag */
